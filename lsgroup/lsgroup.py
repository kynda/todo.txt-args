...
""" TODO.TXT Group VIew
USAGE:
    t gp  -- view by project
    t gc  -- view by context
    t gpp -- view prioritized by project
    t gcp -- view prioritized by context
"""
...
TODOSH_DIR = os.path.dirname(os.getenv('TODO_FULL_SH'))
